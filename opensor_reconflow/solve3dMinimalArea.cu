...
void sor::ReconFlow::Solve3dMinimalArea(const float *uproj0, const float *vproj0,
	const float *X0, const float *Y0, const float *Z0,
...
void sor::ReconFlow::CleanUp3D(const float *X0, const float *Y0, const float *Z0,
...
void sor::ReconFlow::RemoveEdgeArtifacts3D(const float *X0, const float *Y0, const float *Z0,
	int surfaceWidth, float maxSurfaceArea,
	int w, int h, int s,
	float *X1, float *Y1, float *Z1)
{
