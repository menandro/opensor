...
void sor::CgObject::bindBuffer() {
	glBindVertexArray(this->vao);
}

void sor::CgObject::loadShader(const char *vertexShader, const char *fragmentShader) {
...
void sor::CgObject::loadTexture(cv::Mat texture) {
	if (texture.empty()) {
...
void sor::CgObject::setDrawMode(Mode mode) {
	drawMode = mode;
...
void sor::CgObject::setRenderType(RenderType renderType) {
	this->renderType = renderType;
}

void sor::CgObject::draw() {
