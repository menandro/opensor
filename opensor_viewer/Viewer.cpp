...
void sor::Viewer::setCameraProjectionType(ProjectionType projectionType) {
...
void sor::Viewer::makeCurrent() {
	glfwMakeContextCurrent(window);
}

int sor::Viewer::createWindow(int scrWidth, int scrHeight, const char *windowName)
{
	glfwInit();
...
void sor::Viewer::depthAndVertexCapture() {
	makeCurrent();
...
void sor::Viewer::setFramebuffer() {
...
void sor::Viewer::saveFramebuffer(std::string filename) {
...
void sor::Viewer::close() {
	glfwTerminate();
}

//callbacks
void sor::Viewer::processInput(GLFWwindow *window)
{
...
void sor::Viewer::keyCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
	...
	if (glfwGetKey(window, GLFW_KEY_PERIOD) == GLFW_PRESS) {
		...
		if (viewer->projectionType == sor::Viewer::ProjectionType::ORTHOGRAPHIC) {
...
void sor::Viewer::mouseCallback(GLFWwindow* window, double xpos, double ypos)
{
	Viewer* viewer = (Viewer*)glfwGetWindowUserPointer(window);
...
void sor::Viewer::scrollCallback(GLFWwindow* window, double xoffset, double yoffset)
{
	Viewer* viewer = (Viewer*)glfwGetWindowUserPointer(window);
	if (viewer->projectionType == sor::Viewer::ProjectionType::ORTHOGRAPHIC) {
...
void sor::Viewer::mouseButtonCallback(GLFWwindow* window, int button, int action, int mods)
{
	Viewer* viewer = (Viewer*)glfwGetWindowUserPointer(window);
...
void sor::Viewer::captureDepth(std::string filename) {
	makeCurrent();
	//glBindFramebuffer(GL_FRAMEBUFFER, framebuffer);
	if (!glfwWindowShouldClose(window))
	{
